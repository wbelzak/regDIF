...
arma::mat bernoulli_traceline_cpp(arma::vec p_item, arma::vec theta, arma::mat predictors, int samp_size, int num_quadpts);
...
List categorical_traceline_cpp(arma::vec p_item, arma::vec theta, arma::mat predictors, int samp_size, int num_responses_item, int num_quadpts);
...
List cumulative_traceline_cpp(arma::vec p_item, arma::vec theta, arma::mat predictors, int samp_size, int num_responses_item, int num_quadpts);
...
// d_alpha_cpp
List d_alpha_cpp(arma::vec p_alpha, arma::vec p_phi, arma::mat etable, arma::vec theta, arma::mat mean_predictors, arma::mat var_predictors, int cov, int samp_size, int num_items, int num_quadpts);
RcppExport SEXP _regDIF_d_alpha_cpp(SEXP p_alphaSEXP, SEXP p_phiSEXP, SEXP etableSEXP, SEXP thetaSEXP, SEXP mean_predictorsSEXP, SEXP var_predictorsSEXP, SEXP covSEXP, SEXP samp_sizeSEXP, SEXP num_itemsSEXP, SEXP num_quadptsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type p_alpha(p_alphaSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type p_phi(p_phiSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type etable(etableSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type theta(thetaSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type num_quadpts(num_quadptsSEXP);
    rcpp_result_gen = Rcpp::wrap(d_alpha_cpp(p_alpha, p_phi, etable, theta, mean_predictors, var_predictors, cov, samp_size, num_items, num_quadpts));
    return rcpp_result_gen;
END_RCPP
}
// d_phi_cpp
List d_phi_cpp(arma::vec p_alpha, arma::vec p_phi, arma::mat etable, arma::vec theta, arma::mat mean_predictors, arma::mat var_predictors, int cov, int samp_size, int num_items, int num_quadpts);
RcppExport SEXP _regDIF_d_phi_cpp(SEXP p_alphaSEXP, SEXP p_phiSEXP, SEXP etableSEXP, SEXP thetaSEXP, SEXP mean_predictorsSEXP, SEXP var_predictorsSEXP, SEXP covSEXP, SEXP samp_sizeSEXP, SEXP num_itemsSEXP, SEXP num_quadptsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type p_alpha(p_alphaSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type num_items(num_itemsSEXP);
    Rcpp::traits::input_parameter< int >::type num_quadpts(num_quadptsSEXP);
    rcpp_result_gen = Rcpp::wrap(d_phi_cpp(p_alpha, p_phi, etable, theta, mean_predictors, var_predictors, cov, samp_size, num_items, num_quadpts));
    return rcpp_result_gen;
END_RCPP
}
// d_bernoulli_cpp
List d_bernoulli_cpp(std::string parm, arma::vec p_item, arma::mat etable1, arma::mat etable2, arma::vec theta, arma::mat predictors, int cov, int samp_size, int num_items, int num_quadpts);
...
// d_categorical_cpp
List d_categorical_cpp(std::string parm, arma::vec p_item, Rcpp::List etable, arma::vec theta, arma::mat predictors, int thr, int cov, int samp_size, int num_responses_item, int num_items, int num_quadpts);
